...
;( function( window ) {
	...
	CBPFWTabs2.prototype._init = function() {
		// tabs elems
		this.tabs2 = [].slice.call( this.el.querySelectorAll( 'nav > ul > li' ) );
		// content items
		this.items = [].slice.call( this.el.querySelectorAll( '.content-wrap2 > div' ) );
		// current index
		this.current = -1;
	...
	CBPFWTabs2.prototype._show = function( idx ) {
		...
		this.items[ this.current ].className = 'content-current2';
	};
